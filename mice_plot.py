...
for i in range(round(len(mice)/596)):
    ...
    # ax.scatter(x_a[0],y_a[0],z_a[0], fc='b', s = 30)
    # ax.scatter(x_a[1:],y_a[1:],z_a[1:] ,fc='b', s = 3)
    # ax.scatter(x_b[0],y_b[0],z_b[0], fc='r', s = 30)
    # ax.scatter(x_b[1:],y_b[1:],z_b[1:],fc='r', s = 3)
    # ax.view_init(elev=100., azim=50)
    ax = fig.add_subplot()
    ax.scatter(x_a[0],y_a[0], fc='b', s = 500)
    ax.scatter(x_a[1:],y_a[1:], fc='b', s = 3)
    ax.scatter(x_b[0],y_b[0], fc='r', s = 500)
